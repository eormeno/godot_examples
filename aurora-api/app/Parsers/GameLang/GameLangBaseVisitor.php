...
/**
 * This class provides an empty implementation of {@see GameLangVisitor},
 * which can be extended to create a visitor which only needs to handle a subset
 * of the available methods.
 */
class GameLangBaseVisitor extends AbstractParseTreeVisitor implements GameLangVisitor
{
	/**
	 * {@inheritdoc}
	 *
