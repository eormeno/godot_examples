...
moduleHeader : VERSION WS DOUBLELITERAL WS CLASS_;
...
ifElseIfBlockStmt :
	ELSEIF_ WS ifConditionStmt WS THEN endOfStatement
	block?
;
...
ambiguousKeyword :
	...
	CALL | CASE | CLASS_ | CLOSE | CHDIR | CHDRIVE | COLLECTION | CONST |
	...
	EACH | ELSE | ELSEIF_ | END | ENUM | EQV | ERASE | ERROR | EVENT |
